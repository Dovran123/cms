...
class User extends Authenticatable
{
    ...
    public function worker(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
        ...
        return $this->hasOne(Worker::class,'uzivatel_fk','id');
    }
    public function messenge(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
    ...
    public function blog(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        ...
        return $this->hasMany(Blog::class,'id','uzivatel_fk');
    }
}
